...
//        dd($data);
    ...
    {
        return view(self::PATH_VIEW.__FUNCTION__, compact('product','categories', 'sizes', 'colors','colors_user'));
    }
...
//        dd($data);
    ...
    {   
        ...
        $productVarieries = ProductVariant::where('product_id',$product->id);
        $products = Product::where('id',$product->id);
        $product_galleries->delete();
        $productVarieries->delete();
        $products->delete();
        return back();
    }
}
