<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFours"
           aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-fw fa-wrench"></i>
            <span>Quản lý hóa đơn</span>
        </a>
        <div id="collapseFours" class="collapse" aria-labelledby="collapseFours"
             data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Danh sách chức năng:</h6>
                <a class="collapse-item" href="{{route('admin.order-hoadon')}}">Danh sách</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapsefive" class="collapse" aria-labelledby="collapsefive"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Danh sách chức năng:</h6>
                <a class="collapse-item" href="{{route('admin.phanquyen.index')}}">Danh sách</a>
            </div>
        </div>
    </li>
