                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="price"
                                           placeholder="Nhập giá gốc sản phẩm" value="{{$product->price}}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Giá giảm</label>
                                    <input type="text" class="form-control"  name="price_sale"
                                           placeholder="Nhập giá giảm giá sản phẩm" value="{{$product->price_sale}}">
                                </div>
                                <div class="mb-3">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="collapse show" id="collapseStatus">
                            ...
                            <div class="card-body">
                                ...
                                <select value="" class="form-control form-select-lg mb-3" id="choices-publish-status-input"
